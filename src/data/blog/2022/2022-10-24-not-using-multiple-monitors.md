...
description: 아마도 많은 개발자들은 듀얼 모니터를 사용할 것이다. 하나의 모니터에서는 메신저나 개발에 필요한 화면을 띄우고, 다른 모니터로는 개발 프로그램을 열어서 사용하는 게 대부분일 것으로 보인다. 나도 예전에는 맥북프로 화면으로 메신저를 키고 연결된 모니터로 개발 프로그램을 키고 업무를 ...
pubDatetime: 2022-10-24T09:00:00Z
tags: [workflow]
heroImage: https://dlp7yaj6myr6fvex.public.blob.vercel-storage.com/images/2022/10/24/image1.jpeg
---
...
![맥에 있는 여러 데스크탑 사용하는 화면](https://dlp7yaj6myr6fvex.public.blob.vercel-storage.com/images/2022/10/24/image1.jpeg)
...
![한 화면에 왼쪽은 개발 문서, 오른쪽에는 개발 프로그램이 있다](https://dlp7yaj6myr6fvex.public.blob.vercel-storage.com/images/2022/10/24/image2.png)
...
![맥 디스플레이 설정 화면. 기본 값을 사용하지 않고 3008x1692 scaled 된 값으로 설정되어 있다](https://dlp7yaj6myr6fvex.public.blob.vercel-storage.com/images/2022/10/24/image3.png)
...
![4k로 설정했을 때 나타나는 개발 문서 화면. 글씨가 작아 보인다.](https://dlp7yaj6myr6fvex.public.blob.vercel-storage.com/images/2022/10/24/image4.png)
*4k*

![3008x1692 scale로 설정했을 때 나타나는 개발 문서 화면. 글씨가 4k에 비해 훨씬 커 보인다.](https://dlp7yaj6myr6fvex.public.blob.vercel-storage.com/images/2022/10/24/image5.png)
*3008x1692 scale*
