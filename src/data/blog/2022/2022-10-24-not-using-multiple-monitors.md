...
tags: [workflow]
heroImage: /images/2022/10/24/image1.jpeg
---
...
![맥에 있는 여러 데스크탑 사용하는 화면](/images/2022/10/24/image1.jpeg)
...
![한 화면에 왼쪽은 개발 문서, 오른쪽에는 개발 프로그램이 있다](/images/2022/10/24/image2.png)
...
![맥 디스플레이 설정 화면. 기본 값을 사용하지 않고 3008x1692 scaled 된 값으로 설정되어 있다](/images/2022/10/24/image3.png)
...
![4k로 설정했을 때 나타나는 개발 문서 화면. 글씨가 작아 보인다.](/images/2022/10/24/image4.png)
*4k*

![3008x1692 scale로 설정했을 때 나타나는 개발 문서 화면. 글씨가 4k에 비해 훨씬 커 보인다.](/images/2022/10/24/image5.png)
*3008x1692 scale*
