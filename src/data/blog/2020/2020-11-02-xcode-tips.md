...
![Xcode Annotiations, TODO, MARK, FIXME](/images/2020/11/02/image1.png){:width="90%"}
...
![Controller Outline, which shows each annotation has a separate icon](/images/2020/11/02/image2.png){:width="90%"}

![Minimap, which shows a block of section and shows what MARK annotation says](/images/2020/11/02/image3.png){:width="25%"}
...
![#warning, write a message and shows the message at the Issue Navigator](/images/2020/11/02/image4.png){:width="90%"}
...
![GIF of using delete key for disappearing search result at Find Navigator](/images/2020/11/02/image5.GIF)