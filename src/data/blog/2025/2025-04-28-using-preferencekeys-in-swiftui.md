...
이후 뷰에서 [preference(key:value:)](https://developer.apple.com/documentation/swiftui/view/preference(key:value:)) 수정자로 값을 설정하고, 상위 뷰에서는 `.onPreferecenceChange(\_:perform:)` 수정자로 변경을 감지한다.
...
[onPreferenceChange\(_:perform:\)](https://developer.apple.com/documentation/swiftui/view/onpreferencechange%28_:perform:%29)
