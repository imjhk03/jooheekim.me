...
description: Swift의 stride() 함수를 사용하여 수열을 생성하는 방법과 활용법
...
[stride\(from:to:by:\)](https://developer.apple.com/documentation/swift/stride%28from:to:by:%29)

[stride\(from:through:by:\)](https://developer.apple.com/documentation/swift/stride%28from:through:by:%29)
...
[\[Swift\] Strideable Protocol](https://min-i0212.tistory.com/39)