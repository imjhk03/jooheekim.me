...
이 modifier를 사용하여 다음과 같은 [`InsettableShape`](https://developer.apple.com/documentation/swiftui/insettableshape) 프로토콜을 준수하는 도형들을 뷰 뒤에 레이어링할 수 있다:

- [`Rectangle`](https://developer.apple.com/documentation/swiftui/rectangle) - 직사각형 모양
- [`Circle`](https://developer.apple.com/documentation/swiftui/circle) - 원형 모양
- [`Capsule`](https://developer.apple.com/documentation/swiftui/capsule) - 캡슐 모양
- [`RoundedRectangle`](https://developer.apple.com/documentation/swiftui/roundedrectangle) - 둥근 모서리 직사각형
...
[background\(_:in:fillStyle:\)](https://developer.apple.com/documentation/swiftui/view/background(in:fillstyle:)-96bda)
