...
pubDatetime: 2025-05-19T09:00:00Z
tags: [swift, expressions]
---

[SE-0380](https://github.com/swiftlang/swift-evolution/blob/main/proposals/0380-if-switch-expressions.md)에서 `if`와 `switch` 표현식(expression)이 Swift 5.9에 추가 되면서 `return` 키워드 없이 코드를 더 줄여서 작성할 수 있게 되었다.
