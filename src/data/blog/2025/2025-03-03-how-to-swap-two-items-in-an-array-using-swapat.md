...
description: Swift의 swapAt() 함수를 사용하여 배열에서 두 항목의 위치를 바꾸는 방법
...
[swapAt\(_:_:\) | Apple Developer Documentation](https://developer.apple.com/documentation/swift/array/swapat%28_:_:%29)