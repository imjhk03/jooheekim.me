...
heroImage: https://dlp7yaj6myr6fvex.public.blob.vercel-storage.com/images/2025/01/13/image1.png
tags: [swift, strings]
---
...
### 조건부 텍스트 처리하기
`@autoclosure`를 활용하면 조건에 따라 다른 텍스트를 출력하는 보간법을 만들 수 있다.`@autoclosure`를 사용하면 간단한 값이나 복잡한 함수를 기본값으로 사용할 수 있다는 의미다. 이 [블로그](https://ericasadun.com/2018/12/12/the-beauty-of-swift-5-string-interpolation/)에서 예를 보면 삼항 연산자(ternary expression)을 대신해서 조건에 출력하는 값을 조절할 수 있다.
```swift
extension String.StringInterpolation {
...
![Attributed Strings](https://dlp7yaj6myr6fvex.public.blob.vercel-storage.com/images/2025/01/13/image1.png)
...
[SE-0228](https://github.com/swiftlang/swift-evolution/blob/main/proposals/0228-fix-expressiblebystringinterpolation.md)
