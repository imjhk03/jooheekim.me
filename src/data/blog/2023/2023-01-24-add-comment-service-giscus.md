...
tags: [blog, jekyll]
heroImage: /images/2023/01/24/image1.png
---
...
![Chirpy 튜토리얼 블로그 글에 있는 댓글 기능, giscus](/images/2023/01/24/image1.png)
...
![Giscus 사이트에 있는 설정 화면. 언어, 저장소 주소, 페이지와 Discussions 연결에 대한 설정이 나와 있다.](/images/2023/01/24/image2.png)
...
![Dicsussion 카테고리 설정 화면](/images/2023/01/24/image3.png)

기타 기능이나 테마도 선택할 수 있고, 설정하면 아래와 같이 웹 사이트 템플릿에 적용할 수 있는 script 태그가 나타난다.

![설정한 내용들이 나와 있는 script 태그 코드가 나타난다.](/images/2023/01/24/image4.png)

적용하는 템플릿에 알맞게 적용하면 되고, 나는 여기서 Chirpy 테마에서 필요한 값들만 적용해서 반영했다.

![블로그에 댓글 기능 추가한 화면](/images/2023/01/24/image5.png)
